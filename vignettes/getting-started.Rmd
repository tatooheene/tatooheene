...
Based on this, we now know that the friction period in 2023 is `r v_5yr_mean_friciton` days. We can now calculate the productivity costs for sick leave spells.
