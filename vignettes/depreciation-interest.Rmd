...
-   The formula and meaning of the annuity factor and the annual
...
Let: - $V$ = replacement value, - $R$ = salvage value at end of
period, - $N$ = amortisation period (years), = $i$ = annual interest
rate (decimal).
...
When $i$ = 0, the function uses the mathematical limit: - $a = N$, -
$k = (V - R)/N$.
