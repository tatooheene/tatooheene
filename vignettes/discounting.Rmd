...
Although yearly and monthly discounting approaches produce the same total undiscounted QALYs or costs, they differ in discounted values due to when outcomes are assumed to occur. In annual models, outcomes are often assumed to occur at the end of the year, while in sub-annual models the rewards are typically accrued more evenly across time. This leads to slightly higher present values in the latter, as benefits (or costs) occur earlier and are therefore less discounted.
...
## 
For demonstration purposses we will make use of the Sick-Sicker example 
```{r exmple-}
