...
Using the formulate this gives us:

```{r}
discount_stream(values = v_c_SoC, discount_rate = "costs" )
```

#Q do we like the opbion to aggregate values direct - meaning the sum #Q do we like discount to be one function and check f

First year: €100 \* (1+0.03)-0 = €100.00 Second year: €100 \* (1+0.03)-1 = €97.09 Third year: €100 \* (1+0.03)-2 = €94.26 Total costs after 3 years are then €291.35.
